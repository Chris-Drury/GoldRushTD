...
public class ZephyrTower extends TowerDecorator {
	
	public ZephyrTower(Tower t) {
		super(t); 
		setTextures( new Texture(Gdx.files.internal("TileSkins/GridTile_ZephyrTower.png")), new Texture(Gdx.files.internal("TileSkins/GridTileOver_ZephyrTower.png")));
		setElement();
	}
	...
	public void setElement() {super.setElement(Element.Zephyr);}
