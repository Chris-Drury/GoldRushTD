...
public class AquaTower extends TowerDecorator{

	public AquaTower(Tower t) {
		super(t); 
		setTextures( new Texture(Gdx.files.internal("TileSkins/GridTile_AquaTower.png")), new Texture(Gdx.files.internal("TileSkins/GridTileOver_AquaTower.png")));
		setElement();
	}
	...
	public void setElement() {super.setElement(Element.Aqua);}
